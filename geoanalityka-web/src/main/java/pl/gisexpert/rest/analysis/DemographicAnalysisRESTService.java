...
import pl.gisexpert.cms.model.analysis.demographic.*;
...
public class DemographicAnalysisRESTService {
	...
	public Response advancedAnalysis(AdvancedAnalysisForm advancedAnalysisForm) {
		...
		case RADIUS:
			...
			peopleByWorkingAgeSums = addressStatService.peopleByWorkingAgeSums(advancedAnalysisForm.getRadius(), advancedAnalysisForm.getPoint());
