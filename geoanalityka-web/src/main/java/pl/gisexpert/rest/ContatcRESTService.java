...
import pl.gisexpert.rest.model.ContactForm;
...
public class ContatcRESTService {
	...
	public Response sendContactForm(ContactForm contactForm) {
		
		String subject = "Geoanalizy - wiadomość od " + contactForm.getName();
